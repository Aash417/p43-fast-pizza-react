    ...
    <div>
      ...
      <Form method="post">
        ...
        <div>
          ...
          <div>
            <input
              className="w-full rounded-full border border-s px-4 py-2 text-sm transition-all duration-300 focus:outline-none focus:ring focus:ring-yellow-400 md:px-6 md:py-3"
              type="text"
              name="address"
              required
            />
...
export async function action({ request }) {
	...
	if (!isValidPhone(order.phone))
		errors.phone = 'please give us your correct phone no.';
